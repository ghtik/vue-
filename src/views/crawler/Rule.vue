<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      >
      <el-breadcrumb-item>南轩配置</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图 -->
    <el-card style="min-height: 800px">
      ...
      <el-table :data="ruleList" border stripe>
        ...
        <el-table-column align="center" label="南轩版本(左1右2)" width="120">
  ...
  methods: {
    ...
    getRuleFromCrawler() {
      this.$http
        ...
        .then((res) => {
          if (res.data.code != "200")
            return this.$message.error("获取南轩所属失败");
