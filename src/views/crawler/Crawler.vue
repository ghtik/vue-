<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>南轩列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图 -->
    <el-card style="min-height: 400px">
      <el-row>
        ...
        <el-col :span="2" :offset="16">
          <el-button type="primary" @click="addCrawler">添加南轩</el-button>
        </el-col>
      </el-row>
      <!-- 南轩列表 -->
      <el-table :data="crawlerlist" border stripe>
        ...
        <el-table-column label="南轩时间" prop="cron"></el-table-column>
    ...
    <el-dialog :close-on-click-modal="false" title="添加南轩" :visible.sync="dialogVisible" width="50%">
      <el-form
        label-position="left"
        :model="form"
        :rules="rules"
      ...
      >
        ...
        <el-form-item label="南轩时间" prop="cron">
    ...
    <el-dialog :close-on-click-modal="false" title="修改南轩" :visible.sync="editDialogVisible" width="50%">
      <el-form
        label-position="left"
        :model="editFrom"
        :rules="rules"
